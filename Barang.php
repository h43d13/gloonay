			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link active dropdown" href="#" id="navbardrop" data-toggle="dropdown">Barang</a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="tambah/Barang.php">Tambah Data</a>
						</div>
					</li>
		...
		<table class="table table-striped table-hover table-sm table-bordered">
          ...
          <th>AKSI</th>
			...
			<tbody>
				...
				$sql = mysqli_query($koneksi, "CALL TampilBarang") or die(mysqli_error($koneksi));
              ...
              <td>'.$data['harga'].'</td>
							<td>
								<a href="edit/Barang.php?id='.$data['id_barang'].'" class="badge badge-warning">
								Edit
								</a>
								<a href="hapus/Barang.php?id='.$data['id_barang'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">
								Delete
								</a>
							</td>
						</tr>
