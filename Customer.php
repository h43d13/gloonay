			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link active dropdown" href="#" id="navbardrop" data-toggle="dropdown">Customer</a>
						<div class="dropdown-menu">
							<a class="dropdown-item" href="tambah/Customer.php">Tambah Data</a>
						</div>
					</li>
	...
	<div class="container" style="margin-top:20px">
		...
		<table class="table table-striped table-hover table-sm table-bordered">
			...
			<tbody>
				...
				$sql = mysqli_query($koneksi, "SELECT * FROM customer ORDER BY id_cust ASC") or die(mysqli_error($koneksi));
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_array($sql)){
						...
						<tr>
							...
							<td>
								<a href="edit/Customer.php?id='.$data['id_cust'].'" class="badge badge-warning">
								Edit
								</a>
								<a href="hapus/Customer.php?id='.$data['id_cust'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">
								Delete
								</a>
							</td>
						</tr>
