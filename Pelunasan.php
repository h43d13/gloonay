	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item active"><a class="nav-link" href="Pelunasan.php">Pelunasan</a></li>
	...
	<table class="table table-striped table-hover table-sm table-bordered">
		...
		<tbody>
			<?php
				...
				$sql = mysqli_query($koneksi, "SELECT * FROM pelunasan ORDER BY id_lunas ASC") or die(mysqli_error($koneksi));
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_array($sql)){
						...
						<tr>
							...
							<td>'.$data['jml_lunas'].'</td>
							<td>'.$data['pelunasan'].'</td>
							<td>
								<a href="edit1.php?id='.$data['id_lunas'].'" class="badge badge-warning">Edit</a>
								<a href="delete1.php?id='.$data['id_lunas'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">Delete</a>
							</td>
						</tr>
						';
						$no++;
