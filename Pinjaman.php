		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					...
					<li class="nav-item active"><a class="nav-link" href="Pinjaman.php">Pinjaman</a></li>
		...
		<table class="table table-striped table-hover table-sm table-bordered">
			<thead class="thead-dark">
				<tr>
					...
					<th>Jumlah Pinjam</th>
					<th>Lama Angsuran</th>
					<th>Jumlah Bunga Angsuran</th>
					<th>Jumlah Harga Angsuran</th>
					<th>Total Bunga</th>
			...
			<tbody>
				...
				$sql = mysqli_query($koneksi, "SELECT * FROM pinjaman ORDER BY id_pinjam ASC") or die(mysqli_error($koneksi));
              ...
              <td>'.$data['jml_angsuran_bunga'].'</td>
              <td>'.$data['jml_angsuran_pinjam'].'</td>
              <td>'.$data['total_bunga'].'</td>
              <td>'.$data['total_pinjaman'].'</td>
              <td>'.$data['status'].'</td>
							<td>
								<a href="edit1.php?id='.$data['id_pinjam'].'" class="badge badge-warning">
								Edit
								</a>
								<a href="delete1.php?id='.$data['id_pinjam'].'" class="badge badge-danger" onclick="return confirm(\'Yakin ingin menghapus data ini?\')">
								Delete
								</a>
							</td>
						</tr>
